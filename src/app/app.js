var browser = require( 'airplay-js' ).createBrowser(),
    browserXbmc = require( 'airplay-xbmc' ).createBrowser(),
    readTorrent = require( 'read-torrent' ),
    numeral = require('numeral'),
    gui = require('nw.gui'),
    emitter = gui.Window.get(),
    chromecastjs = require('chromecast-js'),
    subtitles_server = new (require("subtitles-server"))(),
    srt2vtt2 = require('srt2vtt2'),
    scfs = new (require("simple-cors-file-server"))(),
    currentVersion = gui.App.manifest.version,
    path = require("path"),
    execPath = path.dirname( process.execPath ),
    chromecaster = new chromecastjs.Browser(),
    isMac = process.platform.indexOf('dar')>-1 || process.platform.indexOf('linux')>-1,
    global_href = "192.168.0.101:8000",
    path = require('path'),
    port = 8010,
    connect = require('connect'),
    address = require('network-address'),
    serveStatic = require('serve-static'),
    escaped_str = require('querystring'),
    last_played = '',
    ...
    updater = require('nw-updater')({'channel':'beta', "currentVersion": currentVersion,'endpoint':'http://torrentv.github.io/update.json'});
